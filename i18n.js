...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'account.guestSignIn': 'Guest · Sign in',
      'account.guestSignInTitle': 'Sign in or create an account',
      ...
      'friends.shareLabel': 'Share my location',
      'friends.shareTitle': 'Let accepted friends see where you are',
      'friends.shareHint': "Friends can only see your location while this is on — turn it off and they immediately stop seeing anything new.",
      'friends.shareOn': 'On',
      'friends.shareOff': 'Off',
      'friends.addLabel': 'Add a friend by email',
      'friends.addSubmit': 'Send request',
      'friends.errNotFound': 'No account found for that email.',
      'friends.errSelf': "That's your own email.",
      'friends.errAlready': "You're already friends.",
      'friends.errPending': 'You already sent that person a request.',
      'friends.errGeneric': 'Something went wrong. Try again.',
      'friends.requestSent': 'Request sent to {email}.',
      'friends.incoming': 'Friend requests',
      'friends.outgoing': 'Sent requests',
      'friends.yourFriends': 'Your friends',
      'friends.empty': 'No friends yet — add one by email above.',
      'friends.accept': 'Accept',
      'friends.declineTitle': 'Decline request',
      'friends.cancelTitle': 'Cancel request',
      'friends.removeTitle': 'Remove friend',
      'friends.pending': 'Pending',
      'friends.notSharing': 'Not sharing right now',
      'friends.sharing': 'Sharing',
      'friends.distanceAway': '{distance} away',
      'friends.disclaimer': "A friend only ever sees your location while your own Share toggle is on. Turning it off, or removing a friend, stops it immediately — nothing is kept once sharing stops.",
    ...
    de: {
      ...
      'account.guestSignIn': 'Gast · Anmelden',
      'account.guestSignInTitle': 'Anmelden oder Konto erstellen',
      ...
      'friends.shareLabel': 'Meinen Standort teilen',
      'friends.shareTitle': 'Bestätigte Freunde sehen, wo du bist',
      'friends.shareHint': 'Freunde sehen deinen Standort nur, solange das an ist — schaltest du es aus, sehen sie ab sofort nichts Neues mehr.',
      'friends.shareOn': 'An',
      'friends.shareOff': 'Aus',
      'friends.addLabel': 'Freund per E-Mail hinzufügen',
      'friends.addSubmit': 'Anfrage senden',
      'friends.errNotFound': 'Für diese E-Mail-Adresse wurde kein Konto gefunden.',
      'friends.errSelf': 'Das ist deine eigene E-Mail-Adresse.',
      'friends.errAlready': 'Ihr seid bereits befreundet.',
      'friends.errPending': 'Du hast dieser Person schon eine Anfrage geschickt.',
      'friends.errGeneric': 'Etwas ist schiefgelaufen. Versuche es erneut.',
      'friends.requestSent': 'Anfrage an {email} gesendet.',
      'friends.incoming': 'Freundschaftsanfragen',
      'friends.outgoing': 'Gesendete Anfragen',
      'friends.yourFriends': 'Deine Freunde',
      'friends.empty': 'Noch keine Freunde — füge oben eine E-Mail-Adresse hinzu.',
      'friends.accept': 'Annehmen',
      'friends.declineTitle': 'Anfrage ablehnen',
      'friends.cancelTitle': 'Anfrage zurückziehen',
      'friends.removeTitle': 'Freund entfernen',
      'friends.pending': 'Ausstehend',
      'friends.notSharing': 'Teilt gerade nicht',
      'friends.sharing': 'Teilt',
      'friends.distanceAway': '{distance} entfernt',
      'friends.disclaimer': 'Ein Freund sieht deinen Standort nur, solange dein eigener Teilen-Schalter an ist. Ihn auszuschalten oder einen Freund zu entfernen, stoppt das sofort — nach dem Beenden bleibt nichts gespeichert.',
    ...
    pl: {
      ...
      'account.guestSignIn': 'Gość · Zaloguj się',
      'account.guestSignInTitle': 'Zaloguj się lub utwórz konto',
      ...
      'friends.shareLabel': 'Udostępnij moją lokalizację',
      'friends.shareTitle': 'Zaakceptowani znajomi widzą, gdzie jesteś',
      'friends.shareHint': 'Znajomi widzą twoją lokalizację tylko, gdy to jest włączone — po wyłączeniu od razu przestają widzieć cokolwiek nowego.',
      'friends.shareOn': 'Wł.',
      'friends.shareOff': 'Wył.',
      'friends.addLabel': 'Dodaj znajomego przez e-mail',
      'friends.addSubmit': 'Wyślij zaproszenie',
      'friends.errNotFound': 'Nie znaleziono konta dla tego adresu e-mail.',
      'friends.errSelf': 'To twój własny adres e-mail.',
      'friends.errAlready': 'Jesteście już znajomymi.',
      'friends.errPending': 'Już wysłałeś/aś tej osobie zaproszenie.',
      'friends.errGeneric': 'Coś poszło nie tak. Spróbuj ponownie.',
      'friends.requestSent': 'Wysłano zaproszenie do {email}.',
      'friends.incoming': 'Zaproszenia do znajomych',
      'friends.outgoing': 'Wysłane zaproszenia',
      'friends.yourFriends': 'Twoi znajomi',
      'friends.empty': 'Nie masz jeszcze znajomych — dodaj kogoś przez e-mail powyżej.',
      'friends.accept': 'Akceptuj',
      'friends.declineTitle': 'Odrzuć zaproszenie',
      'friends.cancelTitle': 'Wycofaj zaproszenie',
      'friends.removeTitle': 'Usuń znajomego',
      'friends.pending': 'Oczekujące',
      'friends.notSharing': 'Nie udostępnia teraz',
      'friends.sharing': 'Udostępnia',
      'friends.distanceAway': '{distance} stąd',
      'friends.disclaimer': 'Znajomy widzi twoją lokalizację tylko wtedy, gdy twój własny przełącznik udostępniania jest włączony. Wyłączenie go lub usunięcie znajomego natychmiast to zatrzymuje — po zakończeniu nic nie jest zapisywane.',
